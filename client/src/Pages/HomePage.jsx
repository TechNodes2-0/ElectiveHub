        ...
        <div className="flex flex-col lg:flex-row justify-between p-2 w-full">
          ...
          <div className="w-full lg:w-1/2">
            <div className="flex flex-col lg:flex-row justify-between relative mb-3 w-full md:mr-3 md:mb-0" data-te-input-wrapper-init>
              ...
              <label
                htmlFor="emailInput"
                className={`pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate py-1 leading-[2.15] text-slate-200 transition-all duration-200 ease-out             
                ${placeHolder || email ? "-translate-y-[2.15rem] scale-[0.8] text-primary" : ""} ${!email && !placeHolder ? "" : "opacity-0 translate-y-[2.15rem] scale-[0.8]"}
