      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <p className='mb-4'>
          ...
          <ul className='list-disc list-inside ml-4'>
            <li>Reproduce, distribute, publicly display, or publicly perform our content except as permitted by the license.</li>
            <li>Modify or create derivative works of our services or content.</li>
            <li>Use our services or content for any commercial purpose or in any manner not permitted by these terms.</li>
