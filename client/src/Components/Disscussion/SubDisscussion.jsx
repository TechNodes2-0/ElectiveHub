      ...
      <div className="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <ul className="mt-16 space-y-5">
                ...
                <div className="sm:flex sm:justify-between">
                  <div>
                    <div className="inline-flex border border-gray-200 rounded-full p-0.5 dark:border-gray-700">
                      <button
                        type="button"
                        className="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-full text-gray-500 hover:bg-blue-100 hover:text-blue-800 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all dark:hover:bg-blue-900 dark:hover:text-blue-200"
                      >
                        <svg
                          className="h-4 w-4"
                          xmlns="http://www.w3.org/2000/svg"
          ...
          <li className="max-w-2xl ml-auto flex justify-end gap-x-2 sm:gap-x-4">
            <div className="grow text-end space-y-3">
              <div className="inline-block bg-blue-600 rounded-lg p-4 shadow-sm">
                <p className="text-sm text-white">what's preline ui figma?</p>
                <div className="mt-3">
                  <button
                    type="button"
                    className="p-2 inline-flex justify-center items-center gap-x-1 rounded-md bg-white/[.1] border border-transparent font-medium text-gray-100 hover:text-gray-600 hover:bg-white focus:outline-none focus:ring-2 ring-offset-blue-600 focus:ring-white focus:ring-offset-2 transition-all text-xs"
                  >
                    <svg
                      className="w-4 h-4"
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <li className="max-w-2xl ml-auto flex justify-end gap-x-2 sm:gap-x-4">
            <div className="grow text-end space-y-3">
              <div className="inline-block bg-blue-600 rounded-lg p-4 shadow-sm">
                <p className="text-sm text-white">show me its code</p>
              </div>
            </div>
          ...
          <li className="flex gap-x-2 sm:gap-x-4">
            ...
            <div className="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
              ...
              <pre className="h-96 language-markup rounded-lg">
                <code className="language-markup" data-lang="html">
                  <div className="border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:border-gray-700">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                      <thead className="bg-gray-50 dark:bg-slate-800">
                        <tr>
                          <th scope="col" className="px-6 py-3 text-left">
          ...
          <li className="max-w-2xl ml-auto flex justify-end gap-x-2 sm:gap-x-4">
            <div className="grow text-end space-y-3">
              <div className="inline-block bg-blue-600 rounded-lg p-4 shadow-sm">
                <p className="text-sm text-white">quiz me about tailwindcss</p>
              </div>
            </div>
          ...
          <li className="flex gap-x-2 sm:gap-x-4">
            ...
            <div className="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
              ...
              <div>
                <button
                  type="button"
                  className="mb-2.5 mr-1.5 py-2 px-3 inline-flex justify-center items-center gap-x-2 rounded-md border border-blue-600 bg-white text-blue-600 align-middle hover:bg-blue-50 text-sm dark:bg-slate-900 dark:text-blue-500 dark:border-blue-500 dark:hover:text-blue-400 dark:hover:border-blue-400"
                >
          ...
          <li className="max-w-2xl ml-auto flex justify-end gap-x-2 sm:gap-x-4">
            <div>
              <div className="text-end">
                <button
                  type="button"
                  className="mb-2.5 ml-1.5 py-2 px-3 inline-flex justify-center items-center gap-x-2 rounded-md border border-blue-600 bg-white text-blue-600 align-middle hover:bg-blue-50 text-sm dark:bg-slate-900 dark:text-blue-500 dark:border-blue-500 dark:hover:text-blue-400 dark:hover:border-blue-400"
                >
          ...
          <div className="absolute bottom-px inset-x-px p-2 rounded-b-md bg-white dark:bg-slate-900">
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                <button
                  type="button"
                  className="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-gray-500 hover:text-blue-600 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all dark:hover:text-blue-500"
                >
                  <svg
                    className="h-4 w-4"
                    xmlns="http://www.w3.org/2000/svg"
