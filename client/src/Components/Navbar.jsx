...
//                     <a
//                       href="/Login"
//                       className={`block py-2 pl-3 pr-4 text-gray-900 hover:dark:text-red-600 rounded hover:bg-transparent md:hover:bg-transparent md:border-0 md:active:text-primary-700 md:hover:text-primary-700 md:p-0 dark:text-white md:dark:hover:text-primary-400 dark:hover:bg-transparent  md:dark:hover:bg-transparent ${
...
//                     <a
//                       href="/Signup"
//                       className={`block py-2 pl-3 pr-4 text-gray-900 hover:dark:text-sky-600 rounded hover:bg-transparent md:active:text-primary-700 md:hover:bg-transparent md:border-0 md:hover:text-primary-700 md:p-0 dark:text-white md:dark:hover:text-primary-400 dark:hover:bg-transparent  md:dark:hover:bg-transparent ${
...
//                     <a
//                       href="/Login"
//                       className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:active:text-primary-700 md:hover:bg-transparent md:border-0 md:hover:text-primary-700 md:p-0 dark:text-white md:dark:hover:text-primary-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
//                     >
//                       Login
//                     </a>
//                   </li>
...
//                     <a
//                       href="/Signup"
//                       className="block py-2 pl-3 pr-4 mr-2 text-gray-900 rounded hover:bg-gray-100 md:active:text-primary-700  md:hover:bg-transparent md:border-0 md:hover:text-primary-700 md:p-0 dark:text-white md:dark:hover:text-primary-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
//                     >
//                       Signup
//                     </a>
//                   </li>
