...
exports.addElectiveSubjectToStudent = async (req, res) => {
  ...
  exports.getElectiveSubjectsForStudent = async (req, res) => {
    try {
      ...
      const studentElectiveSubjects = await StudentElectiveSubject.find({ student: student._id }).populate('electiveSubject');
  ...
  exports.editSubjectOfStudent = async (req, res) => {
    try {
      const { studentId, electiveSubjectId, subjectName, subjectDescription, subjectCode } = req.body;
      const student = await Student.findById(studentId);
      ...
      const studentElectiveSubject = await StudentElectiveSubject.findOne({ student: studentId, electiveSubject: electiveSubjectId })
      ...
      studentElectiveSubject.electiveSubject.subjectDescription = subjectDescription;
